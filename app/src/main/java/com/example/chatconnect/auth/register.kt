    ...
    private fun addUserToDatabase(
        ...
        mDbRef.child("user").child(uid).setValue(userObject)
            .addOnSuccessListener {
                Toast.makeText(this@Register, "User saved successfully", Toast.LENGTH_SHORT).show()

            }.addOnFailureListener { e ->
                Toast.makeText(this@Register, "Failed to save user: ${e.message}", Toast.LENGTH_SHORT).show()
            }
    }
}